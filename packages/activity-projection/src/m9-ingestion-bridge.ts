 ...
 *
 * Architecture:
 *   EventBus → M9IngestionBridge → DurableActivityStore (M9)
 *
 * Invariants:
 *   I1-1: Single M9 ingestion authority (no other DurableActivityStore.append calls)
 ...
 * DurableActivityStore. Does NOT emit to EventBus (I1-8).
 */
