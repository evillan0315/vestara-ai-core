...
// `typescript (92 entry points, 4 risks)`. Keep in sync when the workspace
// gains or loses entry points.
const DOCUMENTED_ENTRY_POINT_COUNT = 92;
const DOCUMENTED_RISK_COUNT = 4;
const DOCUMENTED_LANGUAGE = 'typescript';

describe('RepositoryIntelligence entry point detection', () => {
  it('reports the documented entry point contract (92 entry points, typescript, 4 risks)', async () => {
