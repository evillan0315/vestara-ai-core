/**
 * ARX-015 M7: Runtime Session Types — Session Continuity Authority
 *
 * These types define the session continuity model for M7.
 * They are owned by the opencode-runtime package and re-exported
 * via @vestara/types for cross-package consumption.
 *
 * Architecture:
 *   workflowRunId
 *       ↓
...
import type { RepositoryBindingId, RuntimeSessionId, WorkflowRunId } from '@vestara/types';

// ─── Re-export branded IDs for convenience ──────────────────

export type { RepositoryBindingId, RuntimeSessionId, WorkflowRunId };
