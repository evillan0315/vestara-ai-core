...
export const REGISTRY: Record<RuntimeType, RuntimeDefinition> = {
  ...
  host: {
    ...
    lifecycle: SYSTEM_LIFECYCLE,
    dependencies: ['kernel'],
    metadata: { displayName: 'Host', description: 'Host operating-system integration boundary' },
    version: '1.0.0',
  },
  boot: {
    type: 'boot',
    ...
    lifecycle: SYSTEM_LIFECYCLE,
    dependencies: ['host'],
    metadata: { displayName: 'Boot', description: 'Durable Vestara boot-stage coordinator' },
    version: '1.0.0',
  },
  workspace: {
    type: 'workspace',
