...
export function AssistantResponseActions({ content, failed = false }: AssistantResponseActionsProps) {
  ...
  return (
    <div className="mt-1.5 flex max-w-full flex-wrap items-center gap-1.5" data-testid="assistant-response-actions">
      ...
      {feedback === 'copied' && (
        <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 text-[10px] font-medium text-emerald-300/90 assistant-copy-flash" role="status">
