  ...
  return (
    <div className="hidden max-w-xl flex-1 lg:block">
      <button onClick={openSearch}
        className="flex h-11 w-full items-center gap-3 rounded-xl border border-(--vestara-accent-border) bg-(--vestara-surface) px-4 text-left transition hover:border-(--vestara-accent-border) hover:bg-(--vestara-accent-bg)">
