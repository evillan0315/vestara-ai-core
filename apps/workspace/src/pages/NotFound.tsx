    ...
    <div className="max-w-md mx-auto px-4 py-16 text-center">
      ...
      <div className="flex gap-3 justify-center">
        ...
        <button
          ...
          className="text-xs px-4 py-2 bg-zinc-800 border border-(--vestara-accent-border) text-(--vestara-text-2) rounded hover:bg-zinc-700 transition-colors cursor-pointer"
        >
          Go Back
        </button>
      </div>
